...
export const MARGEM_POR_ITEM_MOCK: MargemPorItem[] = [
  ...
  },
  {
    ...
    cmv: 1255.8,
    margem: 788.97,
    margemPercentual: 0.386,
    precoMinimo: 65.71,
    emRisco: false,
  },
  {
    produtoId: 'file-mignon',
    produto: 'Filé Mignon',
    categoria: 'Carnes',
    quantidade: 9.8,
    unidade: 'kg',
...
export const CONTAS_MOCK: Conta[] = [
  {
    id: 'c1',
    descricao: 'Energia · competência atual',
    categoria: 'Energia',
    centroCusto: 'Equipamentos/câmaras',
    valor: 1180,
  ...
  {
    id: 'c2',
    descricao: 'Fornecedor carne · lote semanal',
    categoria: 'Compras de carne',
    centroCusto: 'Compra de carnes',
    valor: 18400,
    vencimento: dataISO(-5),
    status: 'a_vencer',
    tipo: 'pagar',
  },
  {
    ...
    valor: 6500,
    vencimento: dataISO(4),
    status: 'pago',
    tipo: 'pagar',
  },
  {
    id: 'c4',
    descricao: 'Fiado Ana Ferreira · parcela',
    categoria: 'Fiado',
    centroCusto: 'Administração',
    valor: 320.5,
    vencimento: dataISO(-9),
    status: 'vencido',
    tipo: 'receber',
  },
  {
